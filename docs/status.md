...
| --- | -------------------------------------------------------------------------------- | ------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- | ------------------------------ |
| 1   | **Primitives contract** — prop surface, semantics, allowed leaks                 | [primitives](primitives.md)                 | mapped; driver mechanics verified; overlay/popover root-local ownership validated on iOS (sweep: popover anchored + overlay opens on pushed pages) | lab: Q3 listview cell roots · Q4 controlled inputs | #3, #6, #9, #16, #21, #22, #24, #33 |
