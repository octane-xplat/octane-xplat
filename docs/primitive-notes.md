...
| `KeyboardAvoiding` [native-only]  | — _(web leaf removed — was inert)_                        | scrollview + `input-accessory`/inset management                                                     | iOS vs Android differ internally — acceptable leaf complexity                                                                                                                                                                                                                                                                                                                                                                                     |
...
| `Hoverable` [web-only]            | delayed hover intent + body-portal Popover (`ui/web`)     | — _(native leaf removed)_                                                                           | Touch has no hover; the long-press stand-in was fake parity. Web keeps the card alive while the pointer crosses from the anchor to the portaled card.                                                                                                                                                                                                                                                                                             |
