...
export type { ActivityIndicatorProps, HeadingProps, IconProps, MeterProps, SliderProps } from './props';
...
export type { LinkProps, NavLinkProps, Route, RouteMeta, RouteManifest, ScreenTable, ModalProps, ModalOpenOptions, ModalOpenResult, OpenModal } from './props';
